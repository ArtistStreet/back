...
const normalizeOptionGroups = (value) => {
    ...
    return value
        ...
        const values = Array.isArray(group === null || group === void 0 ? void 0 : group.values)
            ? group.values
...
const normalizeDetailSpecs = (value) => {
    ...
    return value
        ...
        const specValue = item && typeof item.value === "string" ? item.value.trim() : "";
        if (!label || !specValue)
            return null;
...
exports.getProducts = (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        cursor = cursor.populate("seller", "shopName name shopDescription shopAvatar shopCover shopAddress");
        const products = yield cursor;
        const shaped = products.map((obj) => {
            const seller = obj.seller;
            const shopName = seller && (seller.shopName || seller.name)
                ? seller.shopName || seller.name
                : undefined;
            const shopDescription = seller && seller.shopDescription ? seller.shopDescription : undefined;
            const shopAvatar = seller && seller.shopAvatar ? seller.shopAvatar : undefined;
            const shopCover = seller && seller.shopCover ? seller.shopCover : undefined;
            const shopAddress = seller && seller.shopAddress ? seller.shopAddress : undefined;
            const sellerId = seller ? String(seller._id) : undefined;
            delete obj.seller;
            return Object.assign(Object.assign({}, obj), { shopName,
                shopDescription,
                shopAvatar,
                shopCover,
                shopAddress,
...
exports.getProductById = (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        const sellerId = seller ? String(seller._id) : undefined;
        delete obj.seller;
        res.json(Object.assign(Object.assign({}, obj), { shopName,
            shopDescription,
            shopAvatar,
            shopCover,
            shopAddress,
...
exports.updateProduct = (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        if (req.body.isMall !== undefined)
            product.isMall = req.body.isMall;
...
exports.chatbotResponse = (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const completion = yield openai.chat.completions.create({
                ...
                messages: [
                    {
                        role: "system",
                        content: "Bạn là trợ lý ảo hỗ trợ khách hàng cho trang thương mại điện tử ShopBee (phiên bản Blue Glass). Hãy trả lời thân thiện, chuyên nghiệp và ngắn gọn.",
                    },
    ...
    if (userId && partnerId) {
        try {
            const chatMsg = yield ChatMessage.create({
                customer: userId,
                seller: partnerId,
                sender: "seller",
                text: reply,
