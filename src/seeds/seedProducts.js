...
const products = [
  ...
  },
  {
    ...
    isMall: true,
    description:
      "iPhone 15 Pro Max chính hãng VN/A, chip A17 Pro, khung titan, camera 48MP, hỗ trợ 5G, bảo hành 12 tháng.",
    stock: 120,
  },
  {
    ...
    isMall: true,
    description:
      "MacBook Air M2 13 inch, 8GB RAM, 256GB SSD, thiết kế mỏng nhẹ, pin lên đến 18 giờ, phù hợp học tập và làm việc.",
    stock: 60,
  },
  {
    ...
    isMall: true,
    description:
      "Tai nghe AirPods Pro 2 chống ồn chủ động, Spatial Audio, sạc MagSafe, tương thích iOS và Android.",
    stock: 200,
  },
  {
    ...
    isMall: false,
    description:
      "Chuột Logitech MX Master 3S, cảm biến 8K DPI, kết nối Bluetooth/Unifying, tối ưu cho công việc văn phòng.",
    stock: 80,
  },
  {
    ...
    isMall: false,
    description:
      "Bàn phím cơ Keychron K2 V2, layout 75%, hỗ trợ kết nối không dây và có dây, switch Gateron.",
    stock: 90,
  },
  {
    ...
    isMall: false,
    description:
      "Áo thun unisex form oversize, chất liệu cotton 2 chiều thoáng mát, nhiều màu sắc dễ phối đồ.",
    stock: 300,
  },
  {
    ...
    isMall: false,
    description:
      "Giày sneaker trắng đơn giản, dễ phối đồ, phù hợp đi học, đi làm, đi chơi.",
    stock: 150,
  },
];
